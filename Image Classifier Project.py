...
train_datasets = datasets.ImageFolder(data_dir, transform=data_transforms)
valid_datasets = datasets.ImageFolder(data_dir, transform=data_transforms)
...
def process_image(image):
    ...
    transforms.Compose([
        transform.Normalize(mean=[.485, .456, .406], std=[.229, .224, .225]))
    ])
